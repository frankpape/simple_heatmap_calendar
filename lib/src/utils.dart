...
class HeatmapCalendarLocationCalclator {
  ...
  int getOffsetColumn(DateTime date, {int? offsetRow}) {
    ...
    var dateF = date.subtractDays(offsetRow ?? getOffsetRow(date));
    var startDateF = startDate.subtractDays(offsetRowWithStartDate);
    var offsetWeek = dateF.differenceInDays(startDateF) ~/ 7;
